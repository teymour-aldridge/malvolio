...
/// The `<noscript>` tag. The contents of this tag will be shown to people whose
...
/// Creates a new `NoScript` tag – functionally equivalent to
/// `NoScript::new(<text>)` (but easier to type.)
