...
/// Creates a new `<div>` tag – functionally equivalent to `Div::new()` (but
/// easier to type.)
pub fn div() -> Div {
    Div::new()
}
...
impl Div {
    /// Attaches zero or more children to a `Div`. This method accepts anything
    /// which can be turned into an iterator of `BodyNode`'s (i.e. most tags
    /// that you would expect to be able to use).
    ///
    /// ```
    ...
    /// Allows you to apply a custom function to this `Div`. This function is
    /// useful if you want to modify this tag according to some state
    ...
    /// Attach a single attribute to a `Div`. This will overwrite the existing
    /// attribute, if it has already been defined.
    ...
    /// Attach a new `H1` instance to this class. Note that this method only
    /// allows you to provide text (you cannot pass extra attributes to the
    /// `<h1>` tag). If you want to specify additional attributes, you
    /// should instead use the "child" method (see the documentation of that
    ...
    /// calling the `child` method (but somewhat more concise).
    ///
    /// ```rust
    /// # use malvolio::prelude::*;
    ...
    /// Attach a new `H2` instance to this class. Note that this method only
    /// allows you to provide text (you cannot pass extra attributes to the
    /// `<h1>` tag). If you want to specify additional attributes, you
    /// should instead use the "child" method (see the documentation of that
    /// method for more details).
    ...
    /// Attach a new `H3` instance to this class. Note that this method only
    /// allows you to provide text (you cannot pass extra attributes to the
    /// `<h1>` tag). If you want to specify additional attributes, you
    /// should instead use the "child" method (see the documentation of that
    /// method for more details).
    ...
    /// Attach a new `H4` instance to this class. Note that this method only
    /// allows you to provide text (you cannot pass extra attributes to the
    /// `<h1>` tag). If you want to specify additional attributes, you
    /// should instead use the "child" method (see the documentation of that
    /// method for more details).
    ...
    /// Attach a new `H5` instance to this class. Note that this method only
    /// allows you to provide text (you cannot pass extra attributes to the
    /// `<h1>` tag). If you want to specify additional attributes, you
    /// should instead use the "child" method (see the documentation of that
    /// method for more details).
    ...
    /// Attach a new `H6` instance to this class. Note that this method only
    /// allows you to provide text (you cannot pass extra attributes to the
    /// `<h1>` tag). If you want to specify additional attributes, you
    /// should instead use the "child" method (see the documentation of that
    /// method for more details).
