...
/// Creates a new `P` tag – functionally equivalent to `P::new()` (but easier to
/// type.)
pub fn p() -> P {
    P::default()
}
...
impl P {
    ...
    /// A method to construct a paragraph containing the supplied text. This
    /// will sanitise the text provided beforehand.
